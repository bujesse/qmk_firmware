...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_BASE]   = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_MINS, LCTL_T(KC_ESC), KC_A, KC_S, LSFT_T(KC_D), KC_F, KC_G, KC_H, KC_J, RSFT_T(KC_K), KC_L, KC_SCLN, KC_QUOT, C_S_T(KC_GRV), LGUI_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_EQL, LALT_T(KC_DEL), LT(3, KC_BSPC), LT(2, KC_ENT), LT(2, KC_ENT), LT(4, KC_SPC), LT(5, KC_TAB)),
                                                              ...
                                                              [_NAVFN]  = LAYOUT_split_3x6_3(KC_TRNS, LCTL(KC_F4), RCS(KC_TAB), KC_UP, LCTL(KC_TAB), KC_TRNS, KC_F10, KC_F7, KC_F7, KC_F9, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, LCA(KC_TAB), KC_F11, KC_F4, KC_F5, KC_F6, KC_TRNS, KC_TRNS, KC_TRNS, LCAG(KC_5), LCAG(KC_4), LCAG(KC_3), LCAG(KC_2), LCAG(KC_1), KC_F12, KC_F1, KC_F2, KC_F3, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
                                                              ...
                                                              [_EXTRA]  = LAYOUT_split_3x6_3(QK_BOOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_HUD, RGB_HUI, KC_NO, BU_MOST_PASS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_RMOD, RGB_VAD, RGB_VAI, RGB_MOD, KC_NO, KC_NO, KC_NO, KC_NO, RCS(KC_ESC), KC_CALC, KC_NO, KC_NO, KC_NO, RGB_TOG, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)};
